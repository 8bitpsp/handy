...
#define RES_S_CONTROL_HELP_TEXT \
  "\026"PSP_CHAR_RIGHT"\020 Change mapping\t\026\001\020 Save to "PSP_CHAR_MS"\t\026"PSP_CHAR_TRIANGLE"\020 Load defaults"
...
#define RES_S_NOT_ROTATED   "Not rotated"
#define RES_S_LEFT_ROTATED  "Left-rotated"
#define RES_S_RIGHT_ROTATED "Right-rotated"

#define RES_S_DIR_PAD_UP        "Directional pad Up"
#define RES_S_DIR_PAD_DOWN      "Directional pad Down"
#define RES_S_DIR_PAD_LEFT      "Directional pad Left"
#define RES_S_DIR_PAD_RIGHT     "Directional pad Right"
#define RES_S_BUTTON_A          "Button A"
#define RES_S_BUTTON_B          "Button B"
#define RES_S_OPTION_1          "Option 1"
#define RES_S_OPTION_2          "Option 2"
#define RES_S_PAUSE             "Pause"

#define RES_S_SCREEN_ORIENT "Screen orientation"

#define RES_S_ENABLE_DISABLE_SOUND "\026\001\020 Enable/disable sound"
#define RES_S_CHANGE_SCREEN_ORIENT "\026\001\020 Change screen orientation"
